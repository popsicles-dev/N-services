...
export default function Dashboard() {
    ...
    const leadHeaderRef = useScrollAnimation()
    const leadFormRef = useScrollAnimation()
    const leadResultsRef = useScrollAnimation()
    const auditHeaderRef = useScrollAnimation()
    const auditCardRef = useScrollAnimation()
    const emailHeaderRef = useScrollAnimation()
    const emailCardRef = useScrollAnimation()
    const sendingHeaderRef = useScrollAnimation()
    const sendingCardRef = useScrollAnimation()
    ...
    return (
        <div className="min-h-screen">
            {/* ============ HERO SECTION ============ */}
            <section ref={heroRef} className="fade-in-view relative min-h-[60vh] flex flex-col items-center justify-center text-center px-6 py-20">
                ...
                {/* Headline */}
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 max-w-4xl leading-tight">
                ...
                <button
                    ...
                    className="px-8 py-4 bg-gradient-to-r from-blue-600 to-blue-500 text-white font-semibold rounded-xl shadow-lg shadow-blue-500/30 hover:shadow-xl hover:shadow-blue-500/40 transition-all hover:scale-105 active:scale-95"
                >
