...
@celery_app.task(bind=True, base=DatabaseTask)
def intent_scoring_task(self, job_id: str, input_filename: str, limit: int = 100):
    """Celery task for Intent Scoring using LLM.
    ...
    try:
        ...
        # Run Intent Scoring
        from app.services.intent_scoring import IntentScoringService
        scorer = IntentScoringService()
        ...
        return {
            ...
            'filename': results['output_filename'],
            'total_processed': results['total_processed'],
            'high_intent_count': results['high_intent_count'],
            'medium_intent_count': results['medium_intent_count'],
            'low_intent_count': results['low_intent_count'],
